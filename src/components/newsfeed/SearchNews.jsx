...
export default function SearchNews({ newsData = {} }) {
  ...
  return (
    <div className="col-span-12 grid grid-cols-12 gap-4 lg:col-span-6 p-3   rounded-xl hover:scale-125 slideIn backdrop-blur-lg">
      {/* <!-- info --> */}
      <div className="col-span- md:col-span-6 flex flex-col justify-between">
        <div>
